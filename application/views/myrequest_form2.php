    ...
    <div class="modal-body">
        <form id="form-request" name="form-user">
            ...
            <div class="form-group">
                ...
                <div class="input-group input-daterange">
                    <input style="height:28px;padding:0.5%;background-color: white" type="text" id="date_from" name="date_from" class="form-control" autocomplete="off" readonly>
                    <div class="input-group-addon" style="padding:4px;height:28px;width:32px">to</div>
                    <input style="height:28px;padding:0.5%;background-color: white" type="text" id="date_to" name="date_to" class="form-control" autocomplete="off" readonly>
                </div>
            </div>
            <div class="form-group">
                <label for="role">Assign To: <i style="color:red">*</i></label>
